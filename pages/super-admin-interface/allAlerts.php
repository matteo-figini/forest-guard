...
if ($_POST["param"] == "") {
    ...
    $queryString .= "ON A.Cod_guardiaparchi=U.ID_utente ";
    ...
    $queryString .= "FROM alert A ";
    $queryString .= "INNER JOIN utenti U ";
    $queryString .= "ON A.Cod_guardiaparchi=U.ID_utente AND (ID_alert LIKE '%".$_POST["param"]."%' OR Tipo_alert LIKE '%".$_POST["param"]."%' OR Stato LIKE '%".$_POST["param"]."%') ";
    $queryString .= "ORDER BY Stato, ID_alert DESC";
}
$result = $conn->query($queryString);
if ($result->num_rows > 0) {
    echo "<table class='w3-table w3-responsive w3-striped'>";
    echo "<tr class='w3-green'><td><b>ID</b></td><td><b>Tipo Alert</b></td><td><b>Descrizione</b></td><td><b>Note<b></td><td><b>Stato<b></td><td><b>Latitudine<b></td><td><b>Longitudine<b></td><td><b>Data e ora<b></td><td><b>Parco<b></td><td><b>Guardiaparco<b></td></tr>";
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>".$row["Data"]."</td><td>".$row["Parco_assegnato"]."</td><td>".$row["Nome"]." ".$row["Cognome"]."</td></tr>";
    }
    echo "</table>";
}
?>
