...
if ($_POST["param"] == "") {
    ...
    $queryString .= "ON R.Cod_guardiaparchi=U.ID_utente AND Parco_appartenente='".$_SESSION["Parco"]."' ";
    ...
    $queryString .= "FROM rilevazioni R ";
    $queryString .= "INNER JOIN utenti U ";
    $queryString .= "ON R.Cod_guardiaparchi=U.ID_utente AND Parco_appartenente='".$_SESSION["Parco"]."' AND (ID_rilevazione LIKE '%".$_POST["param"]."%' OR Specie LIKE '%".$_POST["param"]."%' OR Cod_guardiaparchi LIKE '%".$_POST["param"]."%' OR Stato_salute LIKE '%".$_POST["param"]."%') ";
    $queryString .= "ORDER BY Stato_salute, ID_rilevazione DESC";
}
